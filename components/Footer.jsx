...
const Footer = () => {
  ...
  <div className="flex mx-20 container">
        <div className="flex-1 col-lg-3 col-md-6 d-flex">
    ...
    <div className="flex-1 col-lg-3 col-md-6 footer-links d-flex">
    ...
    <div className="flex-1 mt-5 col-lg-3 col-md-6 footer-links">
      <h4>Follow Us</h4>
